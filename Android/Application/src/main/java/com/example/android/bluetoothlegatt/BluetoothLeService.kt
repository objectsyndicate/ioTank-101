...
class BluetoothLeService : Service() {
    ...
    private fun broadcastUpdate(action: String,
        ...
        val intent = Intent(action)
         ...
         if(UUID_IOTANK101 == characteristic.uuid) {
///////////////////////////////////////////////////////////////////////////// ioTank101
            ...
            if (data != null && data.size > 0) {
                ...
                intent.putExtra(EXTRA_DATA, String(data).trim(0x00.toChar()))
    ...
    companion object {
        ...
        val UUID_IOTANK101 = UUID.fromString("3117f4bd-ee31-4253-a1ec-51b6bc8da174")
